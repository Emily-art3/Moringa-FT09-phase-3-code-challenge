...
def get_valid_input(prompt):
    ...
    # Collect user input
author_name = get_valid_input("Enter author's name: ")
magazine_name = get_valid_input("Enter magazine name: ")
magazine_category = get_valid_input("Enter magazine category: ")
article_title = get_valid_input("Enter article title: ")
article_content = get_valid_input("Enter article content: ")
